...
books=pd.read_csv("c:/360DG/Datasets/book.csv")
books.head()
...
#If we will  frequent_itemsets,43 % sale is of cookbook,42 % sale is of child book
#28 % sale is of Do it yourself book
#27.6 % sale is of geography book
#The lowest saling books are are artbooks and Ref.books
...
rules2=rules1[rules1['confidence']==1]
rules2
#1 if customer is buying ItalAtlas, ChildBks, ItalCook then there is 100 % chances it will buy Refbook
# which is lowest saling title,you can provide 20% discount for the same
#2 if cutomer is buying RefBks, ItalArt then there are 100 % chances that cutomer will buy artbook
#offer 20% discount to enhance the sale
