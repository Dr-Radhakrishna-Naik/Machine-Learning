...
The main objective is to create a association rules to insights of earlier models to seller based on support,confidence and lift.
In addition to the Association rules Model prediction, we also have taken into account the  recommendation for a sale increase to mobile company.
