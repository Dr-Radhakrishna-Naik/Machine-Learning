...
In the recruitment domain, HR faces the challenge
 ...
 claims (is 70,000 a month working as a regional manager with an experience of 5 years a genuine claim or does he/she make less than that?) Build a Decision Tree and Random Forest model with monthly income as the target variable
...
1.	Business Problem
 ...
 1.1.1 The Need to Make Quick Hire
      ...
      .With very little time candidates are made to go 
      through multiple rounds screening and interviews, but the need of good calibre and talent is very important at the same time. 
 1.1.2. Importance of Validating/ verifying Credentials
         One of the most common issues we see in the 
         recruitment process is that the candidates not 
        being able to submit the credentials or academic
        validations in relation to the roles they 
        became eligible to apply for the jobs at hand.
        It takes a lot on the part of the recruitment team to actually put across clearly the need for the validations to ensure the authenticity of the candidature. 
 1.1.3. Benchmarking Salaries / Remuneration
       It is usually a tricky situation as to whether
       a benchmarking of the present compensation of the
       candidate or irrespective of the past remuneration,
       an entirely new talent led offer is rolled out.
       Also this may differ from candidate to candidate 
       -Fresher or one with past experience in the same 
       field. The negotiation process that goes on is 
       vital as past that, the offer is rolled out. 
       The acceptance of that offer by the candidate is a persuasion that HR
 
1.2.	Are there any constraints?
    1.2.1 Staffing in today’s day and age is a unique
    task and very few companies get it right. 
    Ours is a large economy and there is currently 
    a demand and supply disequilibrium in most 
    domains- be it the IT industry, Engineering /Manufacturing,
...
import numpy as np
HR=pd.read_csv("c:/360DG/Datasets/HR_DT.csv")
############################
...
#HR possesses large quantities of people data, 
#usually managed in a Human Resources Information System
#. By applying predictive analysis to this data, 
#HR is able to become a strategic partner that relies 
#on proven and data-driven predictive models, 
#instead of relying on gut feeling and soft science. 
#HR predictive analytics enable HR to forecast the 
#impact of people policies on well-being, happiness, 
#and bottom-line performance.
# An example is the role it can play in
# preventing expensive employee turnover.
