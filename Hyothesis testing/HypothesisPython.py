...
############ 1 Sample Sign Test ################
# Student Scores Data
marks = pd.read_csv("C:/Data/hypothesis/Signtest.csv")
marks
...
############# 1-Sample Z-Test #############
#  importing the data
fabric = pd.read_csv("C:\Data\hypothesis\Fabric_data.csv")
...
fuel = pd.read_csv("C:\Data\hypothesis\mann_whitney_additive.csv")
fuel
...
sup = pd.read_csv("C:/Data/hypothesis/paired2.csv")
sup.describe()
