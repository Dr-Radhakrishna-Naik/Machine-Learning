...
(use the scree plot technique to obtain the optimum number of clusters in K-means clustering and check if you’re getting similar results with and without PCA).
 1. Business Problem 
...
wine=pd.read_csv("c:/360DG/Datasets/wine.csv")
#EDA
wine.dtypes
...
wine1 = pd.read_csv("C:/360DG/Datasets/wine.csv")
...
wine3=pd.read_csv("c:/360DG/Datasets/wine.csv")
