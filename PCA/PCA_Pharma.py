...
A pharmaceuticals manufacturing company is conducting a study on a new medicine
 to treat heart diseases. The company has gathered data
 from its secondary sources and would like you to provide high
 level analytical insights on the data.
 Its aim is to segregate patients depending on their age group
 and other factors given in the data. Perform PCA and clustering algorithms
 on the dataset and check if the clusters formed before and after PCA are the same and provide a brief report on your model. 
You can also explore more ways to improve your model. 
 1. Business Problem 
1.1.	What is the business objective?
Cardiovascular disease is the most common cause of mortality in developed
 countries. Across the globe, the incidence of death from cardiovascular
 and circulatory diseases has risen by one third between 1990 and 2010,
 such that by 2015 one in three deaths worldwide will be due to cardiovascular diseases.
 Epidemiologic studies have played an important role in elucidating 
 the factors that predispose to cardiovascular disease and highlighting opportunities for prevention

 
 
 1.2.	Are there any constraints?
 It is difficult to manually determine the odds of getting heart disease 
 based on risk factors. However,  machine learning techniques are useful
 to predict the output from existing data.
...
#oldpeak     float64:oldpeak = ST depression induced by exercise relative to rest
#slope         int64:the slope of the peak exercise ST segment
#ca            int64:number of major vessels (0-3) colored by flourosopy
#thal          int64:thal: 0 = normal; 1 = fixed defect; 2 = reversable defect
...
pharma=pd.read_csv("c:/360DG/Datasets/heart disease.csv")
#EDA
pharma.dtypes
...
pharma2=pd.read_csv("c:/360DG/Datasets/heart disease.csv")
...
#Aglomerative clustering and PCA is best combination giving better results
