# -*- coding: utf-8 -*-
"""
3.	A sample of global companies and their ratings
 are given for the cocoa bean production along with 
 the location of the beans being used.
 Identify the important features in the analysis 
 and accurately classify the companies based on 
 their ratings and draw insights from the data. 
 Build ensemble models such as Bagging, Boosting,
 Stacking, and Voting on the dataset given.
...
1.1.	What is the business objective?
  1.1.1 This analysis will bring some insight into
  consumer patterns in the chocolate industry.
  It will be possible to perhaps see a pattern
  in the data that could lead us to observe why
  a specific amount of cocoa is used in chocolate bars 
  and how it will affect consumer rating.
  Finally, it will show us how geographic factors
  have an impact on the consumption of chocolate,
  and where the highest rated chocolate and 
...
import numpy as np
df=pd.read_excel("C:/360DG/Datasets/Coca_Rating_Ensemble.xlsx")
df.dtypes
df.describe()
