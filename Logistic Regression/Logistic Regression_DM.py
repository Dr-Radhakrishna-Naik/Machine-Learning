# -*- coding: utf-8 -*-
"""
2.	In this time and age of widespread internet usage,
...
1.1.	What is the business objective?
      1.1.1The use of the internet and social media have changed 
      consumer behavior and the ways in which companies conduct
      their business. Social and digital marketing offers
      significant opportunities to organizations through lower
      costs, improved brand awareness and increased sales.
      1.1.2 whether or not a particular internet user clicked on an 
      Advertisement. We will try to create a model that will predict 
      whether or not they will click on an ad based on the features 
      of that user.
1.2.	Are there any constraints?
        significant challenges exist from negative electronic
        word-of-mouth as well as intrusive and irritating 
...
DM=pd.read_csv("c:/360DG/Datasets/advertising.csv")
DM.dtypes
...
#A model  is developed that will predict  whether or not person will 
