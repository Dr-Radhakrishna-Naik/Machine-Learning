# -*- coding: utf-8 -*-
"""
#2.	Perform multilinear regression with price 
#as the output variable and document the different RMSE values.
...
import pandas as pd
import numpy as np
comp=pd.read_csv("c:/360DG/Datasets/Computer_Data.csv")
comp.columns
comp.dtypes
