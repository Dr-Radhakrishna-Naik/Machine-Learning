# -*- coding: utf-8 -*-
"""
Created on Mon Apr 18 19:40:06 2022
...
wbcd.describe()
# in output column there is only B for Benien and M for
#Malignant
#let us first convert it as Benign and Malignant
wbcd['diagnosis']=np.where(wbcd['diagnosis']=='B','Beniegn',wbcd['diagnosis'])
#In wbcd there is column named 'diagnosis',where ever there is 'B' replace with
#'Benign'
