...
sal1=pd.read_csv("c:/360DG/Datasets/SalaryData_Train.csv")
sal2=pd.read_csv("c:/360DG/Datasets/SalaryData_Test.csv")
...
#Location-based analysis can provide you with information 
#about how many people are staying around
#Their family background and their income source 
#so as to improve check-in for a certain area or business, 
#who's checked in most often and how many people have used an offer.
# This kind of information can be very useful in assessing the success of your location-based marketing program.