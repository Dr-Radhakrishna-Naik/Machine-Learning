...
forest=pd.read_csv("c:/360DG/Datasets/forestfires.csv")
...
#In this project we had seen the area wise forest fire and diffret kind of temperature and rainning falls
#also once the fire occurs upto what extend it impacts area wise has been analysed
#also prediction using SVM is done 